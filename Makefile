...
EXTRA=\
	mkfs.c ulib.c user.h cat.c echo.c export.c forktest.c grep.c history.c big.c kill.c\
	ln.c ls.c mkdir.c rm.c stressfs.c signal_test.c usertests.c wc.c zombie.c\
	printf.c umalloc.c sanity.c SMLsanity.c\
